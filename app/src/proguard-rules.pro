...
-keep class com.mutho.music.ui.views.CustomMediaRouteActionProvider { *; }

# Custom Switch, referenced via menu action view class
-keep class com.mutho.music.ui.views.CustomSwitch { *; }
...
-keepnames class com.mutho.music.glide.utils.CustomGlideModule
-keep public class * implements com.bumptech.glide.module.GlideModule
...
-keep class com.mutho.music.http.itunes.** { *; }
-keep class com.mutho.music.http.lastfm.** { *; }
