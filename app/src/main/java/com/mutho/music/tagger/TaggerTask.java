...
import com.mutho.music.model.TagUpdate;
import java.io.File;
            ...
            try {
                ...
                if (tagUpdate.hasChanged()) {
                    ...
                    if (TaggerUtils.requiresPermission(paths)) {
                        temp = new File(MuthoMusicApplication.getInstance().getFilesDir(), orig.getName());
                        tempFiles.add(temp);
                    ...
                    if (requiresPermission && temp != null) {
                        ...
                        if (documentFile != null) {
                            ParcelFileDescriptor pfd = MuthoMusicApplication.getInstance().getContentResolver().openFileDescriptor(documentFile.getUri(), "w");
                            if (pfd != null) {
