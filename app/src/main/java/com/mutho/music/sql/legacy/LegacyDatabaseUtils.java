package com.mutho.music.sql.legacy;
...
public class LegacyDatabaseUtils {
    ...
    public static BriteDatabase getBlacklistDatabase() {
        return new SqlBrite.Builder().build()
                .wrapDatabaseHelper(new BlacklistDbOpenHelper(MuthoMusicApplication.getInstance()), Schedulers.io());
    }
    ...
    public static BriteDatabase getWhitelistDatabase() {
        return new SqlBrite.Builder().build()
                .wrapDatabaseHelper(new WhitelistDbOpenHelper(MuthoMusicApplication.getInstance()), Schedulers.io());
    }
