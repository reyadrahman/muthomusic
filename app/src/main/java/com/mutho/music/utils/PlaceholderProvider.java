...
public class PlaceholderProvider {
    ...
    private PlaceholderProvider() {
        final Resources res = MuthoMusicApplication.getInstance().getResources();
        ...
        Aesthetic.get(MuthoMusicApplication.getInstance()).isDark()
    ...
    public Drawable getPlaceHolderDrawable(@Nullable String displayName, boolean large) {
        ...
        if (!TextUtils.isEmpty(displayName) && SettingsManager.getInstance().useGmailPlaceholders()) {
            ...
            drawable = ContextCompat.getDrawable(MuthoMusicApplication.getInstance(), large ? getLargePlaceHolderResId() : getMediumPlaceHolderResId());
        }
        return drawable;
    }
}
