...
import com.mutho.music.model.ArtworkModel;
...
import com.mutho.music.ui.modelviews.ArtworkLoadingView;
import com.mutho.music.ui.modelviews.ArtworkView;
import com.mutho.music.ui.recyclerview.SpacesItemDecoration;
        ...
        return new MaterialDialog.Builder(context)
                ...
                .onPositive((dialog, which) -> {
                    ...
                    if (checkedView != null) {
                        ...
                        MuthoMusicApplication.getInstance().userSelectedArtwork.put(artworkProvider.getArtworkKey(),
                        ...
                        MuthoMusicApplication.getInstance().userSelectedArtwork.remove(artworkProvider.getArtworkKey());
                    }
                    dialog.dismiss();
                })
                ...
                .onNeutral((dialog, which) -> RxImagePicker.with(context)
                        ...
                        .flatMap(uri -> {
                            ...
                            File dir = new File(MuthoMusicApplication.getInstance().getFilesDir() + "/shuttle/custom_artwork/" + artworkProvider.getArtworkKey().hashCode() + "/");
