...
public final class ShuttleUtils {
            ...
            if (!Settings.System.canWrite(context)) {
                ...
                new AlertDialog.Builder(context)
                        ...
                        .setPositiveButton(R.string.button_ok, (dialog, which) -> {
                            ...
                            intent.setData(Uri.parse("package:" + MuthoMusicApplication.getInstance().getPackageName()));
    ...
    public static boolean isOnline(boolean careAboutWifiOnly) {
        ...
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(MuthoMusicApplication.getInstance());
        ...
        final ConnectivityManager cm = (ConnectivityManager) MuthoMusicApplication.getInstance()
    ...
    public static boolean isLandscape() {
        final int orientation = MuthoMusicApplication.getInstance().getResources().getConfiguration().orientation;
        return orientation == Configuration.ORIENTATION_LANDSCAPE;
    }

    public static boolean isTablet() {
        return MuthoMusicApplication.getInstance().getResources().getBoolean(R.bool.isTablet);
    }
    ...
    public static String getIpAddr() {
        ...
        int i = ((WifiManager) MuthoMusicApplication.getInstance().getSystemService(Context.WIFI_SERVICE)).getConnectionInfo().getIpAddress();
