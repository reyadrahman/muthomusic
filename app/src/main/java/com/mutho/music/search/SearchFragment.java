...
import com.mutho.music.ui.modelviews.AlbumArtistView;
import com.mutho.music.ui.modelviews.AlbumView;
import com.mutho.music.ui.modelviews.EmptyView;
import com.mutho.music.ui.modelviews.LoadingView;
import com.mutho.music.ui.modelviews.SearchHeaderView;
...
import com.mutho.music.utils.menu.albumartist.AlbumArtistMenuCallbacksAdapter;
import com.mutho.music.utils.menu.albumartist.AlbumArtistMenuUtils;
...
public class SearchFragment extends BaseFragment implements
        com.mutho.music.search.SearchView,
    ...
    private SearchHeaderView artistsHeader = new SearchHeaderView(new Header(MuthoMusicApplication.getInstance().getString(R.string.artists_title)));
    private SearchHeaderView albumsHeader = new SearchHeaderView(new Header(MuthoMusicApplication.getInstance().getString(R.string.albums_title)));
    private SearchHeaderView songsHeader = new SearchHeaderView(new Header(MuthoMusicApplication.getInstance().getString(R.string.tracks_title)));
    ...
    public void showToast(String message) {
        Toast.makeText(getContext(), (MuthoMusicApplication.getInstance().getString(R.string.emptyplaylist)), Toast.LENGTH_SHORT).show();
    }
