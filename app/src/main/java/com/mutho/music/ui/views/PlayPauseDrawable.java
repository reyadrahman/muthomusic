...
public class PlayPauseDrawable extends Drawable {
    ...
    public void draw(@NonNull Canvas canvas) {
        ...
        final float barDist = lerp(mPauseBarDistance, -1, mProgress);
        ...
        final float pauseBarHeight = lerp(mPauseBarHeight, mPauseBarHeight - ResourceUtils.toPixels(2.5f), mProgress);
