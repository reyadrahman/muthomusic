...
import com.mutho.music.ui.modelviews.HorizontalAlbumView;
...
public class GenreDetailFragment extends BaseFragment implements
    ...
    public void setData(@NonNull Pair<List<Album>, List<Song>> data) {
        ...
        if (!data.first.isEmpty()) {
            ...
            items.add(new SubheaderView(StringUtils.makeAlbumsLabel(MuthoMusicApplication.getInstance(), data.first.size())));
