package com.mutho.music.ui.upnext
...
import com.mutho.music.glide.palette.ColorSet
import com.mutho.music.glide.palette.ColorSetTranscoder
...
import com.mutho.music.ui.views.RepeatButton
import com.mutho.music.ui.views.ShuffleButton
...
import com.mutho.music.utils.color.ArgbEvaluator
...
class UpNextView constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : LinearLayout(context, attrs, defStyleAttr) {
    ...
    init {
        ...
        playerViewAdapter = object : PlayerViewAdapter() {
            ...
            override fun trackInfoChanged(song: Song?) {
                ...
                if (isLandscape && SettingsManager.getInstance().usePalette) {
    ...
    override fun onAttachedToWindow() {
        ...
        if (isLandscape) {
            ...
            if (SettingsManager.getInstance().usePalette || SettingsManager.getInstance().usePaletteNowPlayingOnly) {
        ...
        override fun onResourceReady(newColorSet: ColorSet, glideAnimation: GlideAnimation<in ColorSet>) {
            ...
            animateColors(
                ...
                UnsafeConsumer { intermediateColorSet ->
                    ...
                    if (SettingsManager.getInstance().tintNavBar) {
                ...
                UnsafeAction {
                    ...
                    if (!SettingsManager.getInstance().usePaletteNowPlayingOnly) {
    ...
    companion object {
        ...
        fun newInstance(context: Context, playerPresenter: PlayerPresenter): UpNextView {
