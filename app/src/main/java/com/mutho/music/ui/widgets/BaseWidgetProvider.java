...
import com.mutho.music.glide.utils.CustomAppWidgetTarget;
...
public abstract class BaseWidgetProvider extends AppWidgetProvider {
    ...
    public SharedPreferences mPrefs = PreferenceManager.getDefaultSharedPreferences(MuthoMusicApplication.getInstance());
