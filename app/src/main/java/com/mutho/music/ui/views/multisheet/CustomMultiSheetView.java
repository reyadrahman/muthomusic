package com.mutho.music.ui.views.multisheet;
...
import com.mutho.music.ui.views.multisheet.MultiSheetSlideEventRelay.SlideEvent;
...
public class CustomMultiSheetView extends MultiSheetView {
    ...
    public void onAttachedToWindow() {
        ...
        MuthoMusicApplication.getInstance().getAppComponent().inject(this);
